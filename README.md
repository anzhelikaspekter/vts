...
|-------------------|-------------------------------------------|-------------------------------------------|-------------|
| **Performance**   | ![](https://img.shields.io/badge/67-orange)  | ![](https://img.shields.io/badge/97-brightgreen)  | ↑ +9        |
...
| **SEO**           | ![](https://img.shields.io/badge/91-orange) | ![](https://img.shields.io/badge/100-brightgreen) | ↑ +34         |
...
| Metric            | Before                                   | After                                    | Improvement |
|-------------------|-------------------------------------------|-------------------------------------------|-------------|
| **Performance**   | ![](https://img.shields.io/badge/86-orange)  | ![](https://img.shields.io/badge/99-brightgreen)  | ↑ +36       |
...
| **SEO**           | ![](https://img.shields.io/badge/90-brightgreen) | ![](https://img.shields.io/badge/100-brightgreen) | ↑ +18           |
...
| Metric            | Before                                   | After                                    | Improvement |
|-------------------|-------------------------------------------|-------------------------------------------|-------------|
| **Performance**   | ![](https://img.shields.io/badge/72-orange)  | ![](https://img.shields.io/badge/99-brightgreen)  | ↑ +36       |
| **Accessibility** | ![](https://img.shields.io/badge/89-orange) | ![](https://img.shields.io/badge/100-brightgreen) | ↑ +34        |
| **Best Practices**| ![](https://img.shields.io/badge/96-brightgreen) | ![](https://img.shields.io/badge/100-brightgreen) | —       |
| **SEO**           | ![](https://img.shields.io/badge/60-orange) | ![](https://img.shields.io/badge/100-brightgreen) | ↑ +18           |
